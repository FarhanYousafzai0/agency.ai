...
const Hero = () => {
  return (
    <>
      <div id='hero' className='h-auto pointer-events-none  w-full py-10  mt-10 flex flex-col items-center text-center dark:text-white text-gray-700  gap-6 sm:px-14 lg:px-22 xl:px-40 overflow-hidden  '>
...
<div className='text-4xl md:text-5xl pointer-events-none lg:text-6xl xl:-text-[84px] font-medium xl:leading-[80px] max-w-4xl'>
