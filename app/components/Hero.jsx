...
const Hero = () => {
  return (
    <>
      <section className='h-screen  w-full  mt-10 flex flex-col items-center text-center dark:text-white text-gray-700  gap-6 sm:px-14 lg:px-22 xl:px-40 overflow-hidden  '>
...
<h1 className='text-4xl md:text-5xl lg:text-6xl xl:-text-[84px] font-medium xl:leading-[80px] max-w-4xl'>
