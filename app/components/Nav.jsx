  ...
  return (
    <nav className="flex w-full py-4 px-3 sticky top-0 z-20 backdrop-blur-2xl bg-white/50 font-normal items-center justify-between sm:px-10">
      ...
      <div className="md:hidden flex items-center">
        ...
        >
          {menuOpen ? (
            <Image src={assets.close_icon} alt="Close menu" className="cursor-pointer" width={32} height={32} />
          ) : (
            <Image src={assets.menu_icon} className="cursor-pointer" alt="Open menu" width={32} height={32} />
          )}
        </button>
      </div>
